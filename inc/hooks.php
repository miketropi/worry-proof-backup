...
// worry-proof-backup:after_save_backup_schedule_config
add_action('worry-proof-backup:after_save_backup_schedule_config', 'worrprba_after_save_backup_schedule_config', 10, 1);
...
// worry-proof-backup:after_backup_cron_completed
add_action('worry-proof-backup:after_backup_cron_completed', 'worrprba_after_backup_cron_completed', 10, 2);
